  ...
  return (
    <div className="contact-importer card">
      ...
      <div className="import-options">
        {isSupported ? (
          ...
          <div className="import-option">
            ...
            <p>Contact Picker API is not supported in this browser. Try Chrome on Android or use file import.</p>
          </div>
        )}
      ...
      <div className="help-text">
        ...
        <ul>
          <li><strong>CSV:</strong> Include columns for name, email, phone</li>
          <li><strong>JSON:</strong> Array of contact objects with name, email, phone fields</li>
        </ul>
      </div>
    </div>
  );
